...
group_txn.add_asset_transfer(
    # asset_transfer = algorand.send.asset_transfer( # We don't need this because we are adding this txn to a txn group...
        AssetTransferParams(
            sender=creator.address,
            receiver=receiver_acct.address,
            asset_id=asset_id,
...
print("\nFor Algorand, with Love, from Pasquale Silvestre:")
